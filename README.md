...
```
cd existing_repo
git remote add origin https://gitlab.dke.univie.ac.at/eis/2024s/group-2.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.dke.univie.ac.at/eis/2024s/group-2/-/settings/integrations)
